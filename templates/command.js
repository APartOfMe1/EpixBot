...
module.exports = {
    ...
    // Optional
    usage: '`{prefix}some-name <arg 1> <arg 2>`, `{prefix}some-name help`', // The command usage. In help messages, {prefix} will be replaced with the bot prefix or a '/' if slashOnly is false
    examples: '`{prefix}some-name test1 test2`, `{prefix}some-name help`', // Some examples of valid messages. In help messages, {prefix} will be replaced with the bot prefix or a '/' if slashOnly is false
