const fs = require('fs');
const dir = "./assets/images/gifs/pat";

module.exports = {
    name: 'pat',
    description: 'Pat a user!',
    category: 'Actions',
    usage: '`{prefix}pat @user` or `{prefix}pat username`',
    examples: '`{prefix}pat @A part of me#0412` or `{prefix}pat A part of me`',
    async execute(msg, args) {
        ...
        msg.channel.send(`**${auth}** patted **${nick}**!`, {
            files: [gif]
        });
    },
};