const fs = require('fs');
const dir = "./assets/images/gifs/wave";

module.exports = {
    name: 'wave',
    description: 'Wave at a user!',
    category: 'Actions',
    usage: '`{prefix}wave @user` or `{prefix}wave username`',
    examples: '`{prefix}wave @A part of me#0412` or `{prefix}wave A part of me`',
    async execute(msg, args) {
        ...
        msg.channel.send(`**${auth}** waved at **${nick}**!`, {
            files: [gif]
        });
    },
};