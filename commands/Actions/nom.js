const fs = require('fs');
const dir = "./assets/images/gifs/nom";

module.exports = {
    name: 'nom',
    description: 'Nom a user!',
    category: 'Actions',
    usage: '`{prefix}nom @user` or `{prefix}nom username`',
    examples: '`{prefix}nom @A part of me#0412` or `{prefix}nom A part of me`',
    async execute(msg, args) {
        ...
        msg.channel.send(`**${auth}** nom'd **${nick}**!`, {
            files: [gif]
        });
    },
};