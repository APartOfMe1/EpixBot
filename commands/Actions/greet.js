const fs = require('fs');
const dir = "./assets/images/gifs/greet";

module.exports = {
    name: 'greet',
    description: 'Greet a user!',
    category: 'Actions',
    usage: '`{prefix}greet @user` or `{prefix}greet username`',
    examples: '`{prefix}greet @A part of me#0412` or `{prefix}greet A part of me`',
    async execute(msg, args) {
        ...
        msg.channel.send(`**${auth}** greeted **${nick}**!`, {
            files: [gif]
        });
    },
};