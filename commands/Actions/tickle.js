const fs = require('fs');
const dir = "./assets/images/gifs/tickle";

module.exports = {
    name: 'tickle',
    description: 'Tickle a user!',
    category: 'Actions',
    usage: '`{prefix}tickle @user` or `{prefix}tickle username`',
    examples: '`{prefix}tickle @A part of me#0412` or `{prefix}tickle A part of me`',
    async execute(msg, args) {
        ...
        msg.channel.send(`**${auth}** tickled **${nick}**!`, {
            files: [gif]
        });
    },
};