const fs = require('fs');
const dir = "./assets/images/gifs/highfive";

module.exports = {
    name: 'highfive',
    description: 'Highfive a user!',
    category: 'Actions',
    usage: '`{prefix}highfive @user` or `{prefix}highfive username`',
    examples: '`{prefix}highfive @A part of me#0412` or `{prefix}highfive A part of me`',
    async execute(msg, args) {
        ...
        msg.channel.send(`**${auth}** highfived **${nick}**!`, {
            files: [gif]
        });
    },
};