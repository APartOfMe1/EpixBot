const fs = require('fs');
const dir = "./assets/images/gifs/boop";

module.exports = {
    name: 'boop',
    description: 'Boop a user!',
    category: 'Actions',
    usage: '`{prefix}boop @user` or `{prefix}boop username`',
    examples: '`{prefix}boop @A part of me#0412` or `{prefix}boop A part of me`',
    async execute(msg, args) {
        ...
        msg.channel.send(`**${auth}** booped **${nick}**!`, {
            files: [gif]
        });
    },
};