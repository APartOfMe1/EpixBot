const fs = require('fs');
const dir = "./assets/images/gifs/kill";

module.exports = {
    name: 'kill',
    description: 'Kill a user!',
    category: 'Actions',
    usage: '`{prefix}kill @user` or `{prefix}kill username`',
    examples: '`{prefix}kill @A part of me#0412` or `{prefix}kill A part of me`',
    async execute(msg, args) {
        ...
        msg.channel.send(`**${auth}** killed **${nick}**!`, {
            files: [gif]
        });
    },
};