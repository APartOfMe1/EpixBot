const fs = require('fs');
const dir = "./assets/images/gifs/hug";

module.exports = {
	name: 'hug',
	description: 'Hug a user!',
	category: 'Actions',
    usage: '`{prefix}hug @user` or `{prefix}hug username`',
    examples: '`{prefix}hug @A part of me#0412` or `{prefix}hug A part of me`',
	async execute(msg, args) {
        ...
        msg.channel.send(`**${auth}** hugged **${nick}**!`, {
            files: [gif]
        });
	},
};