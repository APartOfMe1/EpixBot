const fs = require('fs');
const dir = "./assets/images/gifs/poke";

module.exports = {
    name: 'poke',
    description: 'Poke a user!',
    category: 'Actions',
    usage: '`{prefix}poke @user` or `{prefix}poke username`',
    examples: '`{prefix}poke @A part of me#0412` or `{prefix}poke A part of me`',
    async execute(msg, args) {
        ...
        msg.channel.send(`**${auth}** poked **${nick}**!`, {
            files: [gif]
        });
    },
};