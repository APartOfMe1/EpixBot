const fs = require('fs');
const dir = "./assets/images/gifs/stare";

module.exports = {
    name: 'stare',
    description: 'Stare at a user!',
    category: 'Actions',
    usage: '`{prefix}stare @user` or `{prefix}stare username`',
    examples: '`{prefix}stare @A part of me#0412` or `{prefix}stare A part of me`',
