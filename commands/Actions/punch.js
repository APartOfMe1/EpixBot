const fs = require('fs');
const dir = "./assets/images/gifs/punch";

module.exports = {
    name: 'punch',
    description: 'Punch a user!',
    category: 'Actions',
    usage: '`{prefix}punch @user` or `{prefix}punch username`',
    examples: '`{prefix}punch @A part of me#0412` or `{prefix}punch A part of me`',
    async execute(msg, args) {
        ...
        msg.channel.send(`**${auth}** punched **${nick}**!`, {
            files: [gif]
        });
    },
};