const fs = require('fs');
const dir = "./assets/images/gifs/explode";

module.exports = {
    name: 'explode',
    description: 'Explode a user!',
    category: 'Actions',
    usage: '`{prefix}explode @user` or `{prefix}explode username`',
    examples: '`{prefix}explode @A part of me#0412` or `{prefix}explode A part of me`',
    async execute(msg, args) {
        ...
        msg.channel.send(`**${auth}** exploded **${nick}**!`, {
            files: [gif]
        });
    },
};