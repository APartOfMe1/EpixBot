const fs = require('fs');
const dir = "./assets/images/gifs/bully";

module.exports = {
    name: 'bully',
    description: 'Bully a user!',
    category: 'Actions',
    usage: '`{prefix}bully @user` or `{prefix}bully username`',
    examples: '`{prefix}bully @A part of me#0412` or `{prefix}bully A part of me`',
    async execute(msg, args) {
        ...
        msg.channel.send(`**${auth}** bullied **${nick}**!`, {
            files: [gif]
        });
    },
};